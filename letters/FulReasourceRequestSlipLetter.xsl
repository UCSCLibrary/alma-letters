...
<tr><br></br></tr>
					  <strong></strong>
						<tr>
							<td><h3><strong>@@location@@: </strong><xsl:value-of select="notification_data/phys_item_display/location_name"/></h3></td><br></br></tr>
							<tr><xsl:if test="notification_data/phys_item_display/call_number != ''">
